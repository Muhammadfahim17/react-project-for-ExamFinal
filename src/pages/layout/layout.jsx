    ...
    <div>
        ...
        <header>
          ...
          <Link to={'/main'}>
            ...
            <div>
              <button className='bg-[#C31E26] text-white font-bold px-[30px] py-[8px] rounded-xl'>{t('Example.7')}</button>
            </div>

            <details>
            <summary>🌐 </summary>
            <div className='flex flex-col items-center gap-[10px]'>
        <button onClick={() => TranslateClick("ru")} className=' w-[45px]'>Ru</button>
        <button onClick={() => TranslateClick("en")} className=' w-[45px]'>En</button>
            </div>
          </details>
        ...
        <footer>
          ...
          <div className='w-[93%] m-auto flex items-center justify-between'>
            <h1 className='text-[40px] font-[500] w-[780px]'>{t('Example.8')}</h1>
            <div className='flex flex-col items-start gap-[10px] w-[500px]'>
              <p className='text-[#070707] font-[500]'>{t('Example.9')}</p>
              <button className='bg-[#C31E26] text-white font-[500] px-[35px] py-[7px] rounded-xl'>See More</button>
            </div>
          </div>
        ...
        <div className='flex flex-col items-start gap-[25px]'>
          <div className='bg-gradient-to-r from-[#e0cda5] to-[#ebb00f] text-[#1B1B1B] w-[625px]  flex rounded-xl justify-between items-center p-[25px]'>
            <div>
              <h2 className='text-[#C31E26] text-[22px] font-[600]'>{t('Example.11')}</h2>
              <p className='text-[#C31E26] font-[500]'>{t('Example.12')}</p>
            </div>
          <button className='bg-[#C31E26] font-bold text-white px-[10px] py-[10px] rounded-full'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6"><path strokeLinecap="round" strokeLinejoin="round" d="m4.5 15.75 7.5-7.5 7.5 7.5" /></svg></button>
          </div>
          <div className='bg-gradient-to-r from-[#ffac06] to-[#ebb00f] text-[#1B1B1B] w-[625px]  flex rounded-xl justify-between items-center p-[25px]'>
            <div>
              <h2 className='text-[#1B1B1B] text-[22px] font-[600]'>{t('Example.13')}</h2>
              {/* <p>{t('Example.12')}</p> */}
            </div>
          <button><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6"><path strokeLinecap="round" strokeLinejoin="round" d="m4.5 15.75 7.5-7.5 7.5 7.5" /></svg></button>
          </div>
          <div className='bg-gradient-to-r from-[#ffac06] to-[#ebb00f] text-[#1B1B1B] w-[625px]  flex rounded-xl justify-between items-center p-[25px]'>
            <div>
              <h2 className='text-[#1B1B1B] text-[22px] font-[600]'>{t('Example.14')}</h2>
              {/* <p>{t('Example.12')}</p> */}
            </div>
          <button><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6"><path strokeLinecap="round" strokeLinejoin="round" d="m4.5 15.75 7.5-7.5 7.5 7.5" /></svg></button>
          </div>
          <div className='bg-gradient-to-r from-[#ffac06] to-[#ebb00f] text-[#1B1B1B] w-[625px]  flex rounded-xl justify-between items-center p-[25px]'>
            <div>
              <h2 className='text-[#1B1B1B] text-[22px] font-[600]'>{t('Example.15')}</h2>
              {/* <p>{t('Example.12')}</p> */}
            </div>
          <button><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6"><path strokeLinecap="round" strokeLinejoin="round" d="m4.5 15.75 7.5-7.5 7.5 7.5" /></svg></button>
          </div>
          <div className='bg-gradient-to-r from-[#ffac06] to-[#ebb00f] text-[#1B1B1B] w-[625px]  flex rounded-xl justify-between items-center p-[25px]'>
            <div>
              <h2 className='text-[#1B1B1B] text-[22px] font-[600]'>{t('Example.16')}</h2>
              {/* <p>{t('Example.12')}</p> */}
            </div>
          <button><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6"><path strokeLinecap="round" strokeLinejoin="round" d="m4.5 15.75 7.5-7.5 7.5 7.5" /></svg></button>
          </div>
          <div className='bg-gradient-to-r from-[#ffac06] to-[#ebb00f] text-[#1B1B1B] w-[625px]  flex rounded-xl justify-between items-center p-[25px]'>
            <div>
              <h2 className='text-[#1B1B1B] text-[22px] font-[600]'>{t('Example.17')}</h2>
              {/* <p>{t('Example.12')}</p> */}
            </div>
          <button><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6"><path strokeLinecap="round" strokeLinejoin="round" d="m4.5 15.75 7.5-7.5 7.5 7.5" /></svg></button>
          </div>
          <div className='bg-gradient-to-r from-[#ffac06] to-[#ebb00f] text-[#1B1B1B] w-[625px]  flex rounded-xl justify-between items-center p-[25px]'>
            <div>
              <h2 className='text-[#1B1B1B] text-[22px] font-[600]'>{t('Example.18')}</h2>
              {/* <p>{t('Example.12')}</p> */}
            </div>
          <button><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6"><path strokeLinecap="round" strokeLinejoin="round" d="m4.5 15.75 7.5-7.5 7.5 7.5" /></svg></button>
          </div>
