...
const Category2 = () => {
  ...
  return (
    <div>
     ...
     <div className="w-[100%] bg-[#070707] text-white m-auto flex items-center p-[20px] justify-between">
            <h1 className="text-[40px] font-[500] w-[780px]">
              {t("Example.8")}
            </h1>
            <div className="flex flex-col items-start gap-[20px] w-[500px]">
              <p className=" font-[500]">{t("Example.9")}</p>
              <input type="text" className='border font-bold px-[80px] py-[10px] rounded-xl' placeholder='🔍 Search here' />
            </div>
          </div>
     <div className="w-[100%] m-auto flex items-center px-[40px] justify-between py-[80px] bg-[#070707]">
